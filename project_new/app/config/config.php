 ...
 * تاريخ الإنشاء: 2025-06-03 18:08:50
 */

// إعدادات قاعدة البيانات
define('DB_HOST', 'sql309.infinityfree.com');
define('DB_NAME', 'if0_39152845_new_web');
define('DB_USER', 'if0_39152845');
define('DB_PASS', 'NBtaspbkI6N');
define('DB_CHARSET', 'utf8mb4');

// إعدادات الموقع
define('SITE_URL', 'http://aqnewapp.infinityfreeapp.com');
define('SITE_NAME', 'حداد جده');
define('SITE_TAGLINE', 'أعمال حدادة وتركيب كلادنج احترافية');

// مسارات الملفات
define('PROJECT_ROOT', dirname(__DIR__, 2)); // Corrected to point to project_new root
define('UPLOADS_DIR_NAME', 'public/uploads'); // Adjusted to new public uploads path
