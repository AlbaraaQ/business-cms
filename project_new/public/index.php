...
// تضمين ملف التهيئة
require_once __DIR__ . '/../app/core_init.php'; // Adjusted path

// تضمين ملفات الوظائف اللازمة
// These functions are now expected to be in service-specific files or helpers, loaded by core_init or bootstrap.
// For now, assuming they are made available via GlobalHelper.php or specific service files included by core_init.
// If get_featured_services and get_featured_projects are in specific service files:
require_once __DIR__ . '/../app/services/ServiceService.php'; // Adjusted path
require_once __DIR__ . '/../app/services/ProjectService.php'; // Adjusted path
// If they were in the old global functions.php (now GlobalHelper.php), that should be loaded by core_init.php
...
// $seo_settings = get_page_seo_settings('home'); // This function would be in a helper, e.g., SeoHelper.php
...
<?php
// تضمين ذيل الصفحة
include __DIR__ . '/../app/views/partials/footer.php'; // Adjusted path
?>
