...
require_once __DIR__ . '/../app/core_init.php'; // Should load GlobalHelper, Database, etc.
require_once __DIR__ . '/../app/services/ProjectService.php'; // For project-specific functions
// require_once __DIR__ . '/../app/services/ServiceService.php'; // Likely not needed directly if project functions are self-contained
// require_once __DIR__ . '/../app/helpers/FutureRecommendationsHelper.php'; // If specific functions are used here
